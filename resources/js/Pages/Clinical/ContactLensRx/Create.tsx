            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="font-semibold text-xl text-text-primary leading-tight">
                        {safeT("clinical.rx.new_cl_rx_for", "New Contact Lens Rx for")} {customer.full_name}
                    </h2>
                </div>
            }
        >
            <Head title={safeT("clinical.rx.new_cl_rx", "New Contact Lens Prescription")} />
