...
import { Plus, Search, MapPin, Phone, Edit2, Building2, CheckCircle, XCircle, Star, Eye } from "lucide-react";
    ...
    const columns = [
        {
            ...
            accessor: (branch: Branch) => (
                <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${branch.is_headquarters
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <Card className="p-4 border-l-4 border-l-blue-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-text-muted">Total Branches</p>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">
                                    {stats?.active || branches.data.filter(b => b.is_active).length}
                                </p>
                            </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-red-600 dark:text-red-400 mt-1">
                                    {stats?.inactive || branches.data.filter(b => !b.is_active).length}
                                </p>
                            </div>
                    ...
                    <Card className="p-4 border-l-4 border-l-amber-500">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-text-muted">Headquarters</p>
                                <p className="text-lg font-bold text-text-primary mt-1 truncate">
                                    {stats?.headquarters || hqBranch?.name || "N/A"}
                                </p>
                            </div>
