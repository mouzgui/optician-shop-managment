    ...
    const reportLinks = [
        {
            ...
            href: route("business.reports.daily-revenue"),
            icon: Calendar,
            color: "blue",
        },
        {
            ...
            href: route("business.reports.monthly-revenue"),
            icon: BarChart3,
            color: "green",
        },
        {
            ...
            href: route("business.reports.outstanding-balances"),
            icon: AlertTriangle,
            color: "amber",
        },
        {
            ...
            href: route("business.reports.inventory"),
            icon: ClipboardList,
            color: "purple",
        },
        {
            ...
            href: route("business.reports.staff-performance"),
            icon: Users,
            color: "rose",
        },
        {
            ...
            href: route("business.reports.rx-expiry"),
            icon: Clock,
            color: "orange",
        },
    ];
